...
static AtCommandLineTypedef const At_Commands[] =
{
  ...
  {LB_IPR,   0,   3, "+IPR=%d"                  , NULL                          , &AtIpr    , IGNORE, DEFAULT,      0, 0, &modem_params},
  {LB_CMEE,  0,   3, "+CMEE=1"                  , NULL                          , NULL      , IGNORE, DEFAULT,      0, 0, NULL},
  {LB_CFUN,  5, 180, "+CFUN=1"                  , NULL                          , NULL      , IGNORE, DEFAULT,      0, 0, NULL},
  {LB_APN,   0,   3, "+CGDCONT=1,\"IP\",\"%s\"" , NULL                          , &AtApn    , IGNORE, DEFAULT,      0, 0, &modem_params},
  {LB_CGAT,  0, 180, "+CGATT=1"                 , NULL                          , NULL      , REBOOT, DEFAULT,      0, 0, NULL},
  {LB_CGAT,  0, 180, "+CGACT=1,1"               , NULL                          , NULL      , REBOOT, DEFAULT,      0, 0, NULL},
  {LB_CSQ,   0,   3, "+CSQ"                     , "+CSQ: %d,%d"                 , &AtCsq    , IGNORE, DEFAULT,      0, 0, &modem_params},
  {LB_IP,    0,   3, "+CGPADDR=1"               , "+CGPADDR: 1,\"%d,%d,%d,%d\"" , &AtIpAddr , IGNORE, DEFAULT,      0, 0, &modem_params},
  {LB_CREG,  5,   3, "+CREG?"                   , "+CREG: %d,%d"                , &AtReg    , JUMP  , JUMP   , LB_CSQ, 0, &modem_params},
};
